...
def leeBFS(problem: SearchProblem):
    ...
    while(not nodeQueue.isEmpty()):
        position, path = nodeQueue.pop()

        if problem.isGoalState(position):
            return path

        possibleMoves = problem.getSuccessors(position)
        for move in possibleMoves:
            ...
            if moveCoordinates not in visited:
                ...
                nodeQueue.push((moveCoordinates, newPath))
...
def aStarSearch(problem: SearchProblem, heuristic=nullHeuristic):
    ...
    nodeQueue.push((startPosition, [], 0), 0)
    while(not nodeQueue.isEmpty()):
        position, path, cost = nodeQueue.pop()
        if problem.isGoalState(position):
            return path
        possibleMoves = problem.getSuccessors(position)
        for move in possibleMoves:
            ...
            if not alreadyVisited:
                ...
                nodeQueue.push(newNode, newCost + heuristic(moveCoordinates, problem))
    ...
    while(not nodeQueue.isEmpty()):
        ...
        for move in possibleMoves:
            ...
            if moveCoordinates not in visited:
                visited.append(moveCoordinates)
                newPath = path + [ movePosition ]
                nodeQueue.push((moveCoordinates, newPath), heuristic(moveCoordinates, problem))
