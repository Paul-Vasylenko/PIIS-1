    ...
    def getSuccessors(self, state):
        ...
        for action in Directions.BASE:
            ...
            if not hitsWall:
                ...
                for i in range(0, len(Directions.BASE)):
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    for item in foodList:
        distances.append(mazeDistance(position, item, problem.startingGameState))
...
#     closestFood = findClosestFood(position, foodList)

#     gameState = problem.startingGameState
#     distanceToClosest = mazeDistance(closestFood, position, gameState)

#     stepsToFood = 0
#     for (foodX, foodY) in foodList:
#         flag = 0
#         if foodX!=position[0] and foodX!=closestFood[0]:
#             stepsToFood = stepsToFood + 1
#             flag = 1
        
#         if flag == 0:
#             if foodY!=position[1] and foodY!=closestFood[1]:
#                 stepsToFood = stepsToFood + 1

#     return distanceToClosest + stepsToFood

# def findClosestFood (fromPoint, candidatesList):
